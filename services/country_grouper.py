...
from services.country_data import COUNTRY_NAMES, detect_country
...
class CountryGrouper:
    ...
    def group_by_country(proxies: List[dict]) -> Dict[str, List[str]]:
        ...
        for proxy in proxies:
            ...
            country = CountryGrouper._country_from_region(proxy.get("region")) or CountryGrouper.identify_country(
                name, server
            )
