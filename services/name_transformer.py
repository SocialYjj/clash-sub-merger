...
class NameTransformer:
    ...
    def _get_iso_to_flag():
        ...
        if NameTransformer._ISO_TO_FLAG is None:
            NameTransformer._ISO_TO_FLAG = {
                iso: flag for flag, iso in NameTransformer.FLAG_TO_ISO.items() if iso and iso != "XX"
            }
    ...
    def transform_name(proxy: dict, source_name: str) -> dict:
        ...
        country_name = (saved_country or {}).get("country") or NameTransformer.ISO_TO_COUNTRY.get(
            country_code, "Unknown"
        )
        new_proxy["_country"] = {"country_code": country_code, "country": country_name, "flag": flag}
