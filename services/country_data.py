...
COUNTRY_KEYWORDS: Dict[str, List[str]] = {
    ...
    'JP': ['japan', 'jp', '日本', '日', 'tokyo', '东京', 'osaka', '大阪', 'mejiro', '目白',
           'shinagawa', '品川', 'shibuya', '涩谷', 'shinjuku', '新宿', 'ikebukuro', '池袋',
           'yokohama', '横滨', 'nagoya', '名古屋', 'sapporo', '札幌', 'fukuoka', '福冈'],
    ...
    'DE': ['germany', 'de', 'deutsch', '德国', '德', 'frankfurt', '法兰克福',
           'falkenstein', '法尔肯施泰因', 'berlin', '柏林', 'munich', 'münchen', '慕尼黑',
           'düsseldorf', '杜塞尔多夫', 'hamburg', '汉堡', 'nuremberg', '纽伦堡'],
